    ...
    public partial class InitialMigrations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Reference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, computedColumnSql: "CONCAT('TCK-', YEAR([CreatedDate]), '-', RIGHT('0000' + CAST([TicketNumber] AS VARCHAR(20)), 4))", stored: true),
                    ...
                    AssignedAgent = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
